...
export const RegisterUser = ({ onSubmit }: FormProps) => {
  ...
  const getFriendlyErrorMessage = (code: string) => {
    switch (code) {
      ...
      case "auth/operation-not-allowed":
        return "Sign up is currently disabled for this workspace.";
      default:
        return "Sign up failed. Please check your network and try again.";
    }
  };
  ...
  const handleSocialClick = (platform: string) => {
    setError(
      `Social registration via ${platform} is currently disabled for this workspace.`,
    );
  };
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1.5">
            Get started with TaskNest productivity
          </p>
        </div>
